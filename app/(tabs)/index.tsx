...
// Importando a Lógica (Back) para o Front
import { useCurrencyConverter, FLAGS } from '../../hooks/useCurrencyConverter';

export default function App() {
  // Desestruturando as funções e estados do nosso Hook
  const {
...
// Os estilos (styles) permanecem exatamente os mesmos do código anterior.
const styles = StyleSheet.create({
  ...
  picker: { flex: 1, color: '#FFFFFF', height: 55 },
